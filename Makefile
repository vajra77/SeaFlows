...
seaflows: sflow queue matrix collector broker rrdtool
	$(CC) $(LIBS) $(CFLAGS) -o bin/seaflows -I src/ src/collector/collector.o src/broker/broker.o src/rrdtool/rrdtool.o src/sflow/sflow.o src/queue/queue.o src/matrix/matrix.o src/seaflows.c
